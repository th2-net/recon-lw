...
from recon_lw.core.ts_converters import epoch_nano_str_to_ts

from recon_lw.core.EventsSaver import EventsSaver
from recon_lw.core.utility import open_scoped_events_streams, open_streams, get_next_batch
...
def ob_compare_stats(source_stat_messages_path: pathlib.PosixPath,
    ...
    streams = open_scoped_events_streams(source_ob_events_path,
                                                  lambda n: "default_" not in n)
    streams2 = open_streams(source_stat_messages_path,
    ...
    buffer_len = 100
    while len(streams) > 0:
        next_batch_len = get_next_batch(streams, message_buffer, buffer_len, get_timestamp)
