...
from recon_lw.core.utility import open_scoped_events_streams, get_next_batch
...
def ob_compare_streams(source_events_path: pathlib.PosixPath, results_path: pathlib.PosixPath,
    ...
    streams = open_scoped_events_streams(source_events_path, lambda n: "default_" not in n)
    message_buffer = [None] * 100
    buffer_len = 100
    while len(streams) > 0:
        next_batch_len = get_next_batch(streams, message_buffer, buffer_len, lambda e: e["body"]["timestamp"])
