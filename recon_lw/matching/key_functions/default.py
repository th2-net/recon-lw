...
from recon_lw.matching.key_functions import (
    BasicCopyKeyFunctionProvider,
    BasicOriginalKeyFunctionProvider,
)
from recon_lw.matching.matching_key_extractor import BasicSeparatorMatchingKeyExtractor


def default_key_function(
    filters: List[Union[Filter, FilterProtocol]], key_fields: Set[str], is_copy=False
):
    chain = FilterChain()
